...
const policeIcon = new L.Icon.Default();
  ...
  useEffect(() => {
    const fetchPins = async () => {
      ...
      try {
        ...
        // Expanded to 30km radius (30000m) to ensure stable extraction 
        const query = `
          [out:json][timeout:15];
          (
            node["amenity"="${amenityType}"](around:30000, ${userLocation[0]}, ${userLocation[1]});
            way["amenity"="${amenityType}"](around:30000, ${userLocation[0]}, ${userLocation[1]});
            relation["amenity"="${amenityType}"](around:30000, ${userLocation[0]}, ${userLocation[1]});
          );
          out center;
        `;
